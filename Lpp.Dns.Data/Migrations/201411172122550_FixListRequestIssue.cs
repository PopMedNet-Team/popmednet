namespace Lpp.Dns.Data.Migrations
{
    ...
    public partial class FixListRequestIssue : DbMigration
    {
...
WHERE
	...
	(
		...
		AND
		(
			--Rule #1b: List requests
			EXISTS(SELECT NULL FROM dbo.AclGlobalFiltered(@UserID, '8DCA22F0-EA18-4353-BA45-CC2692C7A844'))
			OR
			EXISTS(SELECT NULL FROM dbo.AclProjectsFiltered(@UserID, '8DCA22F0-EA18-4353-BA45-CC2692C7A844', Requests.ProjectId))
			OR
			...
			(
				...
				-- List Requests: 8DCA22F0-EA18-4353-BA45-CC2692C7A844 (Project and global)
