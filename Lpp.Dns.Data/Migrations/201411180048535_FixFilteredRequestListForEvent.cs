namespace Lpp.Dns.Data.Migrations
{
    ...
    public partial class FixFilteredRequestListForEvent : DbMigration
    {
...
WHERE
	...
	(
	    (
			...
			OR
			--Any Request sent to specified DM in Proj
			EXISTS(SELECT NULL FROM ProjectDataMartEvents WHERE ProjectDataMartEvents.ProjectID=Requests.ProjectId AND ProjectDataMartEvents.DataMartID=@DataMartID
							AND EXISTS(SELECT NULL FROM SecurityGroupUsers WHERE SecurityGroupID = ProjectDataMartEvents.SecurityGroupID AND UserID = @UserID)
							AND EventID IN ('06E30001-ED86-4427-9936-A22200CC74F0','5AB90001-8072-42CD-940F-A22200CC24A2','688B0001-1572-41CA-8298-A22200CBD542','F31C0001-6900-4BDB-A03A-A22200CC019C'))
			OR
			--Any Request sent to any DM in Proj
		...
		(
			...
			AND
			--Any Request sent to specified DM in Proj
			NOT EXISTS(SELECT NULL FROM ProjectDataMartEvents WHERE ProjectDataMartEvents.ProjectID=Requests.ProjectId AND ProjectDataMartEvents.DataMartID=@DataMartID
							AND EXISTS(SELECT NULL FROM SecurityGroupUsers WHERE SecurityGroupID = ProjectDataMartEvents.SecurityGroupID AND UserID = @UserID)
							AND EventID IN ('06E30001-ED86-4427-9936-A22200CC74F0','5AB90001-8072-42CD-940F-A22200CC24A2','688B0001-1572-41CA-8298-A22200CBD542','F31C0001-6900-4BDB-A03A-A22200CC019C')
							AND Allowed=0)
			AND
