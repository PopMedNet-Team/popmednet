namespace Lpp.Dns.Data.Migrations
{
    ...
    public partial class FixResultNeedsApprovalInGetNotifications : DbMigration
    {
...
BEGIN
	...
	INSERT INTO @notifications (TimeStamp, Event, Message)
	SELECT LogsUploadedResultNeedsApproval.TimeStamp, 'Result Needs Approval', LogsUploadedResultNeedsApproval.Description FROM LogsUploadedResultNeedsApproval JOIN UserEventSubscriptions ON LogsUploadedResultNeedsApproval.EventID = UserEventSubscriptions.EventID 
		WHERE
		UserEventSubscriptions.UserID = @UserID
