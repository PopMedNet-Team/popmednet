namespace Lpp.Dns.Data.Migrations
{
    ...
    public partial class AddParentRequestToRequests : DbMigration
    {
        public override void Up()
        {
            AddColumn("dbo.Requests", "ParentRequestID", c => c.Guid());
            CreateIndex("dbo.Requests", "ParentRequestID");
            AddForeignKey("dbo.Requests", "ParentRequestID", "dbo.Requests", "ID");

            // Add the new field to TVFs: FilteredRequestList, FilteredRequestListForEvent, FilteredRequestListWithEvent
...
WHERE
	...
	(
        ...
        {
            DropForeignKey("dbo.Requests", "ParentRequestID", "dbo.Requests");
            DropIndex("dbo.Requests", new[] { "ParentRequestID" });
            DropColumn("dbo.Requests", "ParentRequestID");

            // Remove the new field from TVFs: FilteredRequestList, FilteredRequestListForEvent, FilteredRequestListWithEvent
            Sql(@"ALTER FUNCTION [dbo].[FilteredRequestList]
(	
	@UserID uniqueidentifier
)
