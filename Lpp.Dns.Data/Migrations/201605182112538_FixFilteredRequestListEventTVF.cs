namespace Lpp.Dns.Data.Migrations
{
    ...
    public partial class FixFilteredRequestListEventTVF : DbMigration
    {
...
WHERE
    --Rule #1: Subscriber has any of these rights: New Request Submitted, Routing Status Changed, Submitted Request Awaits a Response, Uploaded Results Need Approval, Request DataMart Metadata Change
	(
	    (
			...
			EXISTS(SELECT NULL FROM ProjectDataMartEvents WHERE ProjectDataMartEvents.ProjectID=Requests.ProjectId AND 
							...
							AND EventID IN ('06E30001-ED86-4427-9936-A22200CC74F0','5AB90001-8072-42CD-940F-A22200CC24A2','688B0001-1572-41CA-8298-A22200CBD542','F31C0001-6900-4BDB-A03A-A22200CC019C', '7535EE61-767E-4C36-BF45-6927B9AFE7C6'))
			OR
	...
	--Rule #2: Subscriber has any of these rights: Request Status Changed, Results Viewed, Submitted Request Needs Approval, Results Reminder, Task Reminder
	(
		(
			...
			EXISTS(SELECT NULL FROM OrganizationEvents WHERE OrganizationEvents.OrganizationID=Requests.OrganizationID
							AND EXISTS(SELECT NULL FROM SecurityGroupUsers WHERE SecurityGroupID = OrganizationEvents.SecurityGroupID AND UserID = @UserID)
							AND EventID IN ('0A850001-FC8A-4DE2-9AA5-A22200E82398','25EC0001-3AC0-45FB-AF72-A22200CC334C','B7B30001-2704-4A57-A71A-A22200CC1736','E39A0001-A4CA-46B8-B7EF-A22200E72B08', '02930001-027b-439e-ae7c-a44200fa221c'))
			OR
