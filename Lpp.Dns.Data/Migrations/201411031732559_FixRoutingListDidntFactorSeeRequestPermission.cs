namespace Lpp.Dns.Data.Migrations
{
    ...
    public partial class FixRoutingListDidntFactorSeeRequestPermission : DbMigration
    {
	...
	(
		...
		(
			...
			(
				...
				OR
				EXISTS(SELECT NULL FROM dbo.AclOrganizationsFiltered(@UserID, '5D6DD388-7842-40A1-A27A-B9782A445E20', Requests.OrganizationID) INNER JOIN DataMarts dm ON dm.OrganizationID = Requests.OrganizationID AND dm.ID = RequestDataMarts.DataMartID)
				OR
			...
			(
				...
				AND
				NOT EXISTS(SELECT NULL FROM dbo.AclOrganizationsFiltered(@UserID, '5D6DD388-7842-40A1-A27A-B9782A445E20', Requests.OrganizationID) a INNER JOIN DataMarts dm ON dm.OrganizationID = Requests.OrganizationID AND dm.ID = RequestDataMarts.DataMartID WHERE a.Allowed = 0)
				AND
