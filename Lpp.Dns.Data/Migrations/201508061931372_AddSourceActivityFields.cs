namespace Lpp.Dns.Data.Migrations
{
    ...
    public partial class AddSourceActivityFields : DbMigration
    {
        public override void Up()
        {
            AddColumn("dbo.Requests", "SourceActivityID", c => c.Guid());
            AddColumn("dbo.Requests", "SourceActivityProjectID", c => c.Guid());
            AddColumn("dbo.Requests", "SourceTaskOrderID", c => c.Guid());
            CreateIndex("dbo.Requests", "SourceActivityID");
            CreateIndex("dbo.Requests", "SourceActivityProjectID");
            CreateIndex("dbo.Requests", "SourceTaskOrderID");
            AddForeignKey("dbo.Requests", "SourceActivityID", "dbo.Activities", "ID");
            AddForeignKey("dbo.Requests", "SourceActivityProjectID", "dbo.Activities", "ID");
            AddForeignKey("dbo.Requests", "SourceTaskOrderID", "dbo.Activities", "ID");
...
WHERE
	...
	(
        ...
        {
            DropForeignKey("dbo.Requests", "SourceTaskOrderID", "dbo.Activities");
            DropForeignKey("dbo.Requests", "SourceActivityProjectID", "dbo.Activities");
            DropForeignKey("dbo.Requests", "SourceActivityID", "dbo.Activities");
            DropIndex("dbo.Requests", new[] { "SourceTaskOrderID" });
            DropIndex("dbo.Requests", new[] { "SourceActivityProjectID" });
            DropIndex("dbo.Requests", new[] { "SourceActivityID" });
            DropColumn("dbo.Requests", "SourceTaskOrderID");
            DropColumn("dbo.Requests", "SourceActivityProjectID");
            DropColumn("dbo.Requests", "SourceActivityID");
