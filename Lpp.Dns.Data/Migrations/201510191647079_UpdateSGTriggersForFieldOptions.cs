namespace Lpp.Dns.Data.Migrations
{
    ...
    public partial class UpdateSGTriggersForFieldOptions : DbMigration
    {
    ...
    BEGIN
        ...
        DELETE FROM AclProjectFieldOptions WHERE SecurityGroupID IN (SELECT ID FROM deleted)
END");
            ...
            Sql(@"ALTER TRIGGER [dbo].[SecurityGroups_InsertItem] 
                    ...
                    BEGIN
						...
						INSERT INTO AclProjectFieldOptions(FieldIdentifier, Permission, ProjectID, Overridden, SecurityGroupID) SELECT acl.FieldIdentifier, acl.Permission, acl.ProjectID, 0, inserted.ID FROM AclProjectFieldOptions AS acl JOIN inserted ON acl.SecurityGroupID = inserted.ParentSecurityGroupID WHERE NOT inserted.ParentSecurityGroupID IS NULL
