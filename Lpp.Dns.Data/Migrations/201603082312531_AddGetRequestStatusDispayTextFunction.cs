namespace Lpp.Dns.Data.Migrations
{
    ...
    public partial class AddGetRequestStatusDispayTextFunction : DbMigration
    {
        public override void Up()
        {
            Sql(@"CREATE FUNCTION [dbo].[GetRequestStatusDisplayText](@RequestID uniqueidentifier) RETURNS nvarchar(50) 
AS
BEGIN
...
END");
        ...
        {
            Sql(@"DROP FUNCTION [dbo].[GetRequestStatusDisplayText]");
        }
    }
}
