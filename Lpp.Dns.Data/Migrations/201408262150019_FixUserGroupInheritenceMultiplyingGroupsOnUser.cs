namespace Lpp.Dns.Data.Migrations
{
    ...
    public partial class FixUserGroupInheritenceMultiplyingGroupsOnUser : DbMigration
    {
        public override void Up()
        {
            ...
            Sql(@"DROP TRIGGER [dbo].[SecurityGroupUsers_DeleteItem]");
            Sql(@"DROP TRIGGER [dbo].[SecurityGroupUsers_InsertItem]");
        }
