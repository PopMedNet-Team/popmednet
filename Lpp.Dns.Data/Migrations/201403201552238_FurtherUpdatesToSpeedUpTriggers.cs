namespace Lpp.Dns.Data.Migrations
{
    ...
    public partial class FurtherUpdatesToSpeedUpTriggers : DbMigration
    {
	...
	while @@fetch_status = 0 begin
		...
		WHERE 
			e.SubjectId IN (SELECT [End] FROM @incomingClosures)
			AND Source.SubjectId IN (SELECT [Start] FROM @incomingClosures)
