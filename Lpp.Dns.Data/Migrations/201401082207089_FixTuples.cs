namespace Lpp.Dns.Data.Migrations
{
    ...
    public partial class FixTuples : DbMigration
    {
...
AS
SELECT DISTINCT 
                         ih1.Start AS Id1, t.ObjectId1 AS ParentId1, RIGHT('00000' + CONVERT(nvarchar(5), ISNULL(ih1.Distance, 0)), 5) AS DistancesJoined, dbo.AclEntries.PrivilegeId, m.Start AS SubjectId, COUNT_BIG(*) AS TotalEntries, 
...
");
            Sql(@"ALTER VIEW [dbo].[_Security_Tuple2] WITH SCHEMABINDING
AS
SELECT DISTINCT       ih1.Start AS Id1, ih2.Start AS Id2, t.ObjectId1 AS ParentId1, t.ObjectId2 AS ParentId2, RIGHT('00000' + CONVERT(nvarchar(5), ISNULL(ih1.Distance, 0)), 5) + RIGHT('00000' + CONVERT(nvarchar(5), 
...
");
            ...
            Sql(@"ALTER VIEW [dbo].[_Security_Tuple3] WITH SCHEMABINDING
AS
SELECT DISTINCT       ih1.Start AS Id1, ih2.Start AS Id2, ih3.Start AS Id3, t.ObjectId1 AS ParentId1, t.ObjectId2 AS ParentId2, t.ObjectId3 AS ParentId3, RIGHT('00000' + CONVERT(nvarchar(5), ISNULL(ih1.Distance, 0)), 5) 
