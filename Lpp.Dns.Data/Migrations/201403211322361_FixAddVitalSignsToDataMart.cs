namespace Lpp.Dns.Data.Migrations
{
    ...
    public partial class FixAddVitalSignsToDataMart : DbMigration
    {
        public override void Up()
        {
            Sql(@"
                if not exists (select 1 from INFORMATION_SCHEMA.COLUMNS where TABLE_NAME = 'DataMarts' and COLUMN_NAME ='VitalSignsLength')
	                ALTER TABLE DATAMARTS ADD VitalSignsLength bit NOT NULL DEFAULT(0)
             ");
...
SELECT        d.DataMartId AS Id, d.DataMartName AS Name, d.Url, d.RequiresApproval, d.DataMartTypeId, d.AvailablePeriod, d.ContactEmail, d.ContactFirstName, d.ContactLastName, d.ContactPhone, d.SpecialRequirements, 
                         ...
                         d.OutpatientEncountersEncounterID, d.OutpatientEncountersProviderIdentifier, d.LongitudinalCapturePatientID, d.LongitudinalCaptureStart, d.LongitudinalCaptureStop, d.LongitudinalCaptureOther, d.LongitudinalCaptureOtherValue,d.VitalSignsLength
FROM            dbo.DataMarts AS d INNER JOIN
        ...
        {
            Sql(@"
                if exists (select 1 from INFORMATION_SCHEMA.COLUMNS where TABLE_NAME = 'DataMarts' and COLUMN_NAME ='VitalSignsLength')
	                ALTER TABLE DATAMARTS DROP COLUMN VitalSignsLength
             ");
            Sql(@"ALTER VIEW [dbo].[DNS3_DataMarts]
AS
SELECT        d.DataMartId AS Id, d.DataMartName AS Name, d.Url, d.RequiresApproval, d.DataMartTypeId, d.AvailablePeriod, d.ContactEmail, d.ContactFirstName, d.ContactLastName, d.ContactPhone, d.SpecialRequirements, 
                         ...
                         d.BiorepositoriesDescription, d.BiorepositoriesDiseaseName, d.BiorepositoriesSpecimenSource, d.BiorepositoriesSpecimenType, d.BiorepositoriesProcessingMethod, d.BiorepositoriesSNOMED, 
                         d.BiorepositoriesStorageMethod, d.BiorepositoriesOther, d.BiorepositoriesOtherText, d.DemographicsOther, d.InpatientEncountersEncounterID, d.InpatientEncountersProviderIdentifier,
                         d.OutpatientEncountersEncounterID, d.OutpatientEncountersProviderIdentifier, d.LongitudinalCapturePatientID, d.LongitudinalCaptureStart, d.LongitudinalCaptureStop, d.LongitudinalCaptureOther, d.LongitudinalCaptureOtherValue
FROM            dbo.DataMarts AS d INNER JOIN
                         dbo.Organizations AS o ON d.OrganizationId = o.OrganizationId");
