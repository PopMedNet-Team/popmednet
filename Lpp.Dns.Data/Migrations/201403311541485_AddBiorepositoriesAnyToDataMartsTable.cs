namespace Lpp.Dns.Data.Migrations
{
    ...
    public partial class AddBiorepositoriesAnyToDataMartsTable : DbMigration
    {
        public override void Up()
        {
            AddColumn("dbo.DataMarts", "BiorepositoriesAny", c => c.Boolean(nullable: false));
...
FROM            dbo.DataMarts AS d INNER JOIN
        ...
        {
            DropColumn("dbo.DataMarts", "BiorepositoriesAny");
