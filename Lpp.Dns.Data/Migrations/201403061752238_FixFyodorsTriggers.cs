namespace Lpp.Dns.Data.Migrations
{
    ...
    public partial class FixFyodorsTriggers : DbMigration
    {
        public override void Up()
        {
            Sql("DROP TRIGGER dbo.SecurityMembershipClosure_UpdateTuples");
            Sql("DROP TRIGGER [dbo].[SecurityInheritanceClosure_UpdateTuples]");
	...
	while @@fetch_status = 0 begin
		...
		INSERT INTO Security_Tuple1 (Id1, ParentId1, SubjectId, PrivilegeId, ViaMemberShip, DeniedEntries, ExplicitDeniedEntries, ExplicitAllowedEntries) SELECT Source.Id1, Source.parentid1, Source.SubjectId, Source.privilegeid, Source.ViaMembership, Source.DeniedEntries, Source.ExplicitDeniedEntries, Source.ExplicitAllowedEntries
		FROM Update_Security_Tuple1 Source 
			...
			INNER JOIN SecurityInheritanceClosure c on i.[End] = c.[End] AND (c.[Start] IS NULL OR (c.[Start] = i.[Start] AND c.[Distance] > i.[Distance]))

		INSERT INTO Security_Tuple2 (Id1, Id2, ParentId1, ParentId2, SubjectId, PrivilegeId, ViaMemberShip, DeniedEntries, ExplicitDeniedEntries, ExplicitAllowedEntries) SELECT Source.Id1, Source.Id2, Source.parentid1, Source.ParentId2, Source.SubjectId, Source.privilegeid, Source.ViaMembership, Source.DeniedEntries, Source.ExplicitDeniedEntries, Source.ExplicitAllowedEntries
		...
		INSERT INTO Security_Tuple3 (Id1, Id2, Id3, ParentId1, ParentId2, ParentId3, SubjectId, PrivilegeId, ViaMemberShip, DeniedEntries, ExplicitDeniedEntries, ExplicitAllowedEntries) SELECT Source.Id1, Source.Id2, Source.Id3, Source.parentid1, Source.ParentId2, Source.ParentId3, Source.SubjectId, Source.privilegeid, Source.ViaMembership, Source.DeniedEntries, Source.ExplicitDeniedEntries, Source.ExplicitAllowedEntries
		...
		INSERT INTO Security_Tuple4 (Id1, Id2, Id3, Id4, ParentId1, ParentId2, ParentId3, ParentId4, SubjectId, PrivilegeId, ViaMemberShip, DeniedEntries, ExplicitDeniedEntries, ExplicitAllowedEntries) SELECT Source.Id1, Source.Id2, Source.Id3, Source.Id4, Source.parentid1, Source.ParentId2, Source.ParentId3, Source.ParentId4, Source.SubjectId, Source.privilegeid, Source.ViaMembership, Source.DeniedEntries, Source.ExplicitDeniedEntries, Source.ExplicitAllowedEntries
		FROM Update_Security_Tuple4 Source 
			INNER JOIN SecurityTargets t ON t.ObjectId1 = Source.ParentId1 AND t.ObjectId2 = Source.ParentId2 AND t.ObjectId3 = Source.ParentId3 AND t.ObjectId4 = Source.ParentId4 AND t.Arity = 4
	...
	while @@fetch_status = 0 begin
		...
		FROM Update_Security_Tuple1 Source 
			...
			INNER JOIN SecurityMembershipClosure c on i.[End] = c.[End] AND (c.[Start] IS NULL OR (c.[Start] = i.[Start] AND c.[Distance] > i.[Distance]))
