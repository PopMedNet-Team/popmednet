                             ...
                             foreach (var term in criteriaGroup.Terms)
                            {
                                switch (term.TermName)
                                {
                                    ...
                                    case "PredefinedLocation":
                                        ...
                                        break;
                                    default:
                                        Write(Html.Partial<Dummy>().WithoutModel());
                                        break;
                                }
                            }
...
WriteAttribute("src", Tuple.Create(" src=\"", 11351), Tuple.Create("\"", 11385)
            
            #line 178 "..\..\Views\ESPQueryBuilder\Compose.cshtml"
, Tuple.Create(Tuple.Create("", 11357), Tuple.Create<System.Object, System.Int32>(this.Resource("compose.js")
