...
namespace Lpp.Dns.HealthCare.ESPQueryBuilder.Data
{
    public class RaceSelectionList
    {
        ...
        public readonly static RaceSelectionList[] races = { Unknown, Native, Asian, Black, Pacific, White };
        public readonly static RaceSelectionList[] ethnicities = { Unknown, Native, Asian, Black, White, Hispanic };
