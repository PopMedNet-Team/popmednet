...
namespace PopMedNet.Dns.Api.DataMarts
{
    ...
    public class DataMartInstalledModelsController : ApiControllerBase<DataContext>
    {
        static readonly Guid QueryComposerModelID = new Guid("455C772A-DF9B-4C6B-A6B0-D4FD4DD98488");

        public DataMartInstalledModelsController(DataContext dataContext) : base(dataContext)
        {
        }
        ...
        public async Task<IActionResult> InsertOrUpdate(UpdateDataMartInstalledModelsDTO updateInfo)
        {
            ...
            if (datamart == null)
                return StatusCode(StatusCodes.Status403Forbidden, "You do not have permission to alter one or more DataMarts referenced.");
        ...
        /// <returns></returns>
        [HttpPost("remove")]
        public async Task<IActionResult> Remove(IEnumerable<DataMartInstalledModelDTO> models)
        {
