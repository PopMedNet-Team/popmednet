namespace Lpp.Dns.Data.Migrations
{
    ...
    public partial class FixProjectDataMartEventsTrigger : DbMigration
    {
        public override void Up()
        {

            Sql(@"ALTER TRIGGER [dbo].[ProjectDataMarts_DeleteItem] 
                ...
                BEGIN
	                ...
	                DELETE a FROM [ProjectDataMartEvents] a INNER JOIN deleted ON a.ProjectID = deleted.ProjectId AND a.DataMartID = deleted.DataMartID
                END");
