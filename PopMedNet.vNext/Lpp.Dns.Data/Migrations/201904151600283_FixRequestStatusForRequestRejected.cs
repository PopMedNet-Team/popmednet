namespace Lpp.Dns.Data.Migrations
{
    ...
    public partial class FixRequestStatusForRequestRejected : DbMigration
    {
                ...
                BEGIN
					...
					BEGIN
						...
						BEGIN
							...
							-- any responses is RejectedRequest
							WHEN EXISTS(SELECT NULL FROM vwRequestStatistics WHERE RejectedRequest > 0 AND RequestID = Requests.ID) THEN 250
							-- all routings are complete
							WHEN EXISTS(SELECT NULL FROM vwRequestStatistics WHERE Completed + RejectedAfterUploadResults + RejectedBeforeUploadResults + Canceled = Total AND RequestID = Requests.ID) THEN 10000 
