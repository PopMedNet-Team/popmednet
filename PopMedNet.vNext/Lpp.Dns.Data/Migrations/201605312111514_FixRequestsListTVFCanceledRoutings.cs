namespace Lpp.Dns.Data.Migrations
{
    ...
    public partial class FixRequestsListTVFCanceledRoutings : DbMigration
    {
			...
			(
				...
				(
					(
						...
						OR
						EXISTS
						(SELECT NULL FROM dbo.AclProjectOrganizationsFiltered(@UserID, '0549F5C8-6C0E-4491-BE90-EE0F29652422', Requests.ProjectId, Requests.OrganizationID))
					)
					AND
					(
						--make sure no denies
						...
						AND
						NOT EXISTS
						(SELECT NULL FROM dbo.AclProjectOrganizationsFiltered(@UserID, '0549F5C8-6C0E-4491-BE90-EE0F29652422', Requests.ProjectId, Requests.OrganizationID) a WHERE a.Allowed = 0)
					)
				)
			)
			OR
