...
namespace PopMedNet.Utilities
{
    public static class Password
    {
        ...
        public static double Strength(string password)
        {
            ...
            int minLength = System.Configuration.ConfigurationManager.AppSettings["PasswordMinLength"].ToNullableInt32() ?? 6;
            int maxLength = System.Configuration.ConfigurationManager.AppSettings["PasswordMaxLength"].ToNullableInt32() ?? 14;
