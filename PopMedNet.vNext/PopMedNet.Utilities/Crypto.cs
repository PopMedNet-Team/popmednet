...
namespace PopMedNet.Utilities
{
    public static class Crypto
    {
        ...
        //    {
        //        des.Key = RandomNumberGenerator.GetBytes(24);
        //        des.GenerateIV();
        //        des.Padding = PaddingMode.Zeros;
        //        using(var trans = des.CreateEncryptor())
        //        {
        //            byte[] data = uniqueID.ToByteArray();
        //            return Base36.NumberToBase36(Convert.ToInt64(BitConverter.ToString(trans.TransformFinalBlock(data, 0, data.Length)).Replace("-", ""), 16)).Replace("-", "0");
        //        }
        //    }
        //}
