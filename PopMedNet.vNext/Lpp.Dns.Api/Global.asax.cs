...
#pragma warning disable 1591
    public class WebApiApplication : System.Web.HttpApplication
    {
        ...
        protected void Application_Start()
        {
            ...
            #region Register Hubs for notifications
            //Find all of the hubs
            var hubTypesToRegister = Assembly.GetExecutingAssembly().GetTypes().Where(
type => type.BaseType != null && !type.IsAbstract &&
type.BaseType.IsGenericType &&
(type.BaseType.GetGenericTypeDefinition() == typeof(LppHub<,>)));

            //Put into dictionary in the data context with the root type, and then the string name of the hub
            foreach (var hub in hubTypesToRegister)
                DataContext.Hubs.Add(hub.BaseType.GetGenericArguments()[1], hub.Name);
