...
{
    [Serializable]
    public class ProxyModelProcessorWithEarlyInitialize : MarshalByRefObject, Model.IEarlyInitializeModelProcessor
    {
        Model.IEarlyInitializeModelProcessor _processor;
        Model.IModelMetadata _modelMetadata;

        public ProxyModelProcessorWithEarlyInitialize() { }        

        public ProxyModelProcessorWithEarlyInitialize(Model.IEarlyInitializeModelProcessor processor) {
        ...
        {
            _processor.Initialize(modelID, documents);
        }
