...
namespace Lpp.Dns.Portal.Views.Request
{
    ...
    #line 2 "..\..\Views\Request\ViewIFrame.cshtml"
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Views/Request/ViewIFrame.cshtml")]
    public partial class ViewIFrame : System.Web.Mvc.WebViewPage<RequestIFrameViewModel>
    {
        public ViewIFrame()
        {
        }
...
WriteLiteral("\r\n");
            ...
            #line 4 "..\..\Views\Request\ViewIFrame.cshtml"
...
"ddEventListener(\"message\", function (event) {\r\n        if (event.origin !== \'");

            
            #line 22 "..\..\Views\Request\ViewIFrame.cshtml"
...
WriteAttribute("src", Tuple.Create(" src=\"", 1448), Tuple.Create("\"", 1464)
            
            #line 38 "..\..\Views\Request\ViewIFrame.cshtml"
, Tuple.Create(Tuple.Create("", 1454), Tuple.Create<System.Object, System.Int32>(iframeUrl
