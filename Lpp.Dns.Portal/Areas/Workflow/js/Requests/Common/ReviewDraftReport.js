...
(function (Workflow) {
    ...
    (function (Common) {
        ...
        (function (ReviewDraftReport) {
            ...
            ReviewDraftReport.ViewModel = ViewModel;
            $.when(Dns.WebApi.Tasks.ByRequestID(Requests.Details.rovm.Request.ID(), null, null, "EndOn desc", null, 1))
                ...
                var bindingControl = $("#CommonReviewDraftReport");
                vm = new ViewModel(bindingControl, Requests.Details.rovm.ScreenPermissions, tasks);
                $(function () {
                    ko.applyBindings(vm, bindingControl[0]);
                });
            });
        })(ReviewDraftReport = Common.ReviewDraftReport || (Common.ReviewDraftReport = {}));
    })(Common = Workflow.Common || (Workflow.Common = {}));
})(Workflow || (Workflow = {}));
//# sourceMappingURL=ReviewDraftReport.js.map