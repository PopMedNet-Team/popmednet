...
module DataChecker {
    ...
    export interface IDiagnosisItemData {
        DP: string;
        DX: string;
        Dx_Codetype: string;
        n: number;
    ...
    export interface ISexItemData {
        DP: string;
        SEX: number;
        Total: number;
    }
    export interface IWeightItemData {
        DP: string;
        WEIGHT: number;
        Total: number;
    }
    export interface IAgeItemData {
        DP: string;
        AGE: number;
        Total: number;
    }
    export interface IHeightItemData {
        DP: string;
        HEIGHT: number;
        Total: number;
    }
