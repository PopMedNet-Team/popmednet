    ...
    (function (Diagnoses) {
        ...
        var ViewModel = (function () {
            function ViewModel(model) {
                ...
                var codes = $.Enumerable.From(table).GroupBy(function (x) { return { Code: x.DX, CodeType: x.Dx_Codetype }; }, function (x) { return x; }, function (key, group) { return key; }, function (key) {
                ...
                this.OverallMetrics = $.Enumerable.From(table).GroupBy(function (x) { return { Code: x.DX, CodeType: x.Dx_Codetype }; }, function (y) { return y; }, function (k, group) { return {
                    Code: k.Code,
                    CodeType: k.CodeType,
                ...
                var total_n_byCode = $.Enumerable.From(table).GroupBy(function (x) { return { Code: x.DX, CodeType: x.Dx_Codetype }; }, function (x) { return x; }, function (key, group) { return { Code: key.Code, CodeType: key.CodeType, Total: $.Enumerable.From(group.source).Sum(function (x) { return x.n; }) }; }, function (key) {
                    return key.Code.toString() + key.CodeType.toString();
                }).ToArray();
                ...
                this.CountByDataPartner = $.Enumerable.From(table).GroupBy(function (x) { return { Code: x.DX, CodeType: x.Dx_Codetype }; }, function (y) { return y; }, function (key, group) { return {
                    Code: key.Code,
                ...
                this.PercentByDataPartner = $.Enumerable.From(table).GroupBy(function (x) { return { Code: x.DX, CodeType: x.Dx_Codetype }; }, function (x) { return x; }, function (k, group) { return {
                    Code: k.Code,
                    CodeType: k.CodeType,
...
//# sourceMappingURL=DiagnosesResponse.js.map