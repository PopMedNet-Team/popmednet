    ...
    (function (Procedures) {
        ...
        var ViewModel = (function () {
            function ViewModel(model) {
                ...
                var codes = $.Enumerable.From(table).GroupBy(function (x) { return { Code: x.PX, CodeType: x.Px_Codetype }; }, function (x) { return x; }, function (key, group) { return key; }, function (key) {
                    return key.Code.toString() + key.CodeType.toString();
                }).ToArray();
                ...
                this.OverallMetrics = $.Enumerable.From(table).GroupBy(function (x) { return { Code: x.PX, CodeType: x.Px_Codetype }; }, function (x) { return x; }, function (key, group) { return {
                    Code: key.Code,
                ...
                var total_n_byCode = $.Enumerable.From(table).GroupBy(function (x) { return { Code: x.PX, CodeType: x.Px_Codetype }; }, function (x) { return x; }, function (key, group) { return { Code: key.Code, CodeType: key.CodeType, Total: $.Enumerable.From(group.source).Sum(function (x) { return x.n; }) }; }, function (key) {
                    return key.Code.toString() + key.CodeType.toString();
                }).ToArray();
                ...
                this.CountByDataPartner = $.Enumerable.From(table).GroupBy(function (x) { return { Code: x.PX, CodeType: x.Px_Codetype }; }, function (y) { return y; }, function (key, group) { return {
                    Code: key.Code,
                    CodeType: key.CodeType,
                ...
                var countByCode = $.Enumerable.From(table).GroupBy(function (x) { return x.DP; }, function (x) { return x; }, function (key, group) { return {
                    Partner: key,
                ...
                this.PercentByDataPartner = $.Enumerable.From(table).GroupBy(function (x) { return { Code: x.PX, CodeType: x.Px_Codetype }; }, function (x) { return x; }, function (k, group) { return {
                    Code: k.Code,
                    CodeType: k.CodeType,
...
//# sourceMappingURL=ProceduresResponse.js.map