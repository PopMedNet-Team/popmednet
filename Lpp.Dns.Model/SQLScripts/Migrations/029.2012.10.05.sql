...
as
	select 
		...
		isnull( p1.LeftIndex, -1 ) as ParentLeftIndex1,
...
as
	select 
		...
		isnull( p1.LeftIndex, -1 ) as ParentLeftIndex1, isnull( p2.LeftIndex, -1 ) as ParentLeftIndex2,
		e.PrivilegeId, e.SubjectId, e.Allow, [Order]
	from dbo.AclEntries e
	inner join dbo.SecurityTargets t on e.TargetId = t.Id
	inner join dbo.SecurityObjects1_p p1 on p1.Id = t.ObjectId1  
...
as
	select 
		...
		isnull( p1.LeftIndex, -1 ) as ParentLeftIndex1, isnull( p2.LeftIndex, -1 ) as ParentLeftIndex2, isnull( p3.LeftIndex, -1 ) as ParentLeftIndex3,
		e.PrivilegeId, e.SubjectId, e.Allow, [Order]
	from dbo.AclEntries e
	inner join dbo.SecurityTargets t on e.TargetId = t.Id
	inner join dbo.SecurityObjects1_p p1 on p1.Id = t.ObjectId1  
...
as
	select 
		...
		isnull( p1.LeftIndex, -1 ) as ParentLeftIndex1, isnull( p2.LeftIndex, -1 ) as ParentLeftIndex2, isnull( p3.LeftIndex, -1 ) as ParentLeftIndex3, isnull( p4.LeftIndex, -1 ) as ParentLeftIndex4,
		e.PrivilegeId, e.SubjectId, e.Allow, [Order]
	from dbo.AclEntries e
	inner join dbo.SecurityTargets t on e.TargetId = t.Id
	inner join dbo.SecurityObjects1_p p1 on p1.Id = t.ObjectId1  
...
as
	select 
		...
		isnull( p1.LeftIndex, -1 ) as ParentLeftIndex1, isnull( p2.LeftIndex, -1 ) as ParentLeftIndex2, isnull( p3.LeftIndex, -1 ) as ParentLeftIndex3, isnull( p4.LeftIndex, -1 ) as ParentLeftIndex4, isnull( p5.LeftIndex, -1 ) as ParentLeftIndex5,
		e.PrivilegeId, e.SubjectId, e.Allow, [Order]
	from dbo.AclEntries e
	inner join dbo.SecurityTargets t on e.TargetId = t.Id
	inner join dbo.SecurityObjects1_p p1 on p1.Id = t.ObjectId1  
