...
{
    public class PreDistributionTestingReview : ActivityBase<Request>
    {
        static readonly Guid ApproveResultID = new Guid("71AC013A-CE8E-419E-A1F0-67BD3B0777EF");
        static readonly Guid RejectResultID = new Guid("C3AE5DF8-DD50-4587-91E1-DD769237F34B");
        ...
        {
            get { return ModularProgramWorkflowConfiguration.PreDistributionTestingReviewID; }
        }
        ...
        public override string ActivityName
        {
            get
            {
                return "Pre-Distribution Testing Review";
            }
        }
        ...
        public override string CustomTaskSubject
        {
            get
            {
                return "Review Pre-Distribution Testing";
            }
        }
        ...
        public override async Task<CompletionResult> Complete(string data, Guid? activityResultID)
        {
            ...
            {
                await SetRequestStatus(DTO.Enums.RequestStatuses.PendingPreDistributionTesting);

                await NotifyRequestStatusChanged(originalStatus, DTO.Enums.RequestStatuses.PendingPreDistributionTesting);
            }
