...
{
    public class HorizontalDistributedRegressionConfiguration : IWorkflowConfiguration
    {
        ...
        public Dictionary<Guid, Type> Activities
        {
            get
            {
                ...
                dict.Add(HorizontalDistributedRegressionConfiguration.DistributionID, typeof(Distribution));
                dict.Add(HorizontalDistributedRegressionConfiguration.CompleteDistributionID, typeof(CompleteDistribution));
                dict.Add(HorizontalDistributedRegressionConfiguration.ConductAnalysisID, typeof(ConductAnalysis));
                dict.Add(HorizontalDistributedRegressionConfiguration.CompletedID, typeof(Completed));
