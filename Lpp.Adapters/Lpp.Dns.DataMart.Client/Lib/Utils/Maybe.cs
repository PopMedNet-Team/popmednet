...
namespace Lpp
{
    ...
    public abstract class MaybeNotNull<T>
    {
        ...
        public virtual T Value { get { throw new InvalidOperationException(); } }
        ...
        {
            public override MaybeKind Kind { get { return MaybeKind.Null; } }
            public override T Value { get { throw new NullReferenceException(); } }
        ...
        class ValueImpl : MaybeNotNull<T>
        {
            ...
            public override MaybeKind Kind { get { return MaybeKind.Value; } }
        ...
        class Error : MaybeNotNull<T>
        {
            ...
            public override T Value { get { throw new ApplicationException(_exception.Message, _exception); } }
        ...
        internal static MaybeNotNull<T> MakeError(Exception ex)
        { //Contract.Requires( ex != null ); 
            return new Error(ex);
        }
        internal static MaybeNotNull<T> MakeValue(T value)
        { //Contract.Requires( value != null ); 
