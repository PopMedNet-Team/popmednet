...
***********************************;
  ...
  %let _SiteCode =  <your site code (same as in VDW StdVars)> ;
  %let _SiteAbbr =  <your site abbreviation (same as in VDW StdVars)> ;
  %let _SiteName =  <your site name (same as in VDW StdVars)>;
...
Example:
  ...
  %let module3=\\root\SPAN\Module3

***********************************;

  %let adhd_datamart=<pathname to your SPAN ADHD datamart>;
  %let obesity_datamart=<pathname to your SPAN Obesity datamart>;
  %let module3=<pathname to your sandbox area for SPAN Module 3 data sets>;
