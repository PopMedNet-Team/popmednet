...
namespace Lpp.Utilities.Legacy
{
    ...
    {
        public static string UnwindException(this Exception exception)
        {
            if (exception.InnerException == null)
                return exception.ToString();

            StringBuilder sb = new StringBuilder();
            UnwindException(exception, sb);
            return sb.ToString();
        }

        public static void UnwindException(this Exception exception, StringBuilder sb)
        {
            sb.AppendLine(exception.ToString());
            if (exception.InnerException != null)
            {
                UnwindException(exception.InnerException, sb);
            }
        }
